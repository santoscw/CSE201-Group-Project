...
<html>
	...
	<body>
		<div id="loginPage" data-role="page" data-theme="a" class="ui-page-header-fixed ui-page-footer-fixed" data-title="Administrator Log In">
			<header data-role='header' data-theme="a" data-position="fixed" data-id="header" data-tap-toggle="false">
				<h1 class="ui-title" data-role="heading">Administrator Log In</h1>
